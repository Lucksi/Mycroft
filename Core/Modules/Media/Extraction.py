        ...
        for element in file_list:
            ...
            if check_string in element:
                if extr == 1:
                    ...
                    f.write(ls)
                    f.close()
                images_s.append(element.replace(check_fol,""))
                ...
                if extr == 1:
                    ...
                    f.write(ls)
                    f.close()
                media_s.append(element.replace(check_fol,""))
        ...
        for elements in document3:
            ...
            if "image" in type:
                if extr == 1:
                    ...
                    f.write(ls)
                    f.close()
                images_s.append(element.replace("Pictures/","").replace("Thumbnails/",""))
                ...
                if extr == 1:
                    ...
                    f.write(ls)
                    f.close()
                media_s.append(element.replace("Media/",""))
