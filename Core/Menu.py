...
class MAIN:
    ...
    def Options():
        ...
        print(Colors.Color.ORANGE + "|" + Colors.Color.GREEN + "--media:" + Colors.Color.WHITE + " Extract media from documents ex: " + Colors.Color.GREEN +"'test.docx --media'" + Colors.Color.ORANGE + "                                                             |")
