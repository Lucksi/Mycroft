...
class GET_BANNER:
    ...
    def Banner(clear_mode):
        ...
        print(Colors.Color.BLUE + "\n[I]" + Colors.Color.WHITE + "Insert {} For Database reset".format(Colors.Color.GREEN + "reset" + Colors.Color.WHITE))
        print(Colors.Color.BLUE + "\n[I]" + Colors.Color.WHITE + "Insert {} For viewing supported files".format(Colors.Color.GREEN + "supported" + Colors.Color.WHITE))